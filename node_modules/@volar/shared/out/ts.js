...
exports.createParsedCommandLine = exports.addCacheLogicToLanguageServiceHost = void 0;
const path = require("upath");
const path_1 = require("./path");
const moduleSpecifierCache_1 = require("./moduleSpecifierCache");
const packageJsonCache_1 = require("./packageJsonCache");
function addCacheLogicToLanguageServiceHost(ts, host, service) {
    ...
    function toPath(fileName) {
        var _a;
        return ts.toPath(fileName, host.getCurrentDirectory(), ts.createGetCanonicalFileName((_a = host.useCaseSensitiveFileNames) === null || _a === void 0 ? void 0 : _a.call(host)));
    }
}
exports.addCacheLogicToLanguageServiceHost = addCacheLogicToLanguageServiceHost;
